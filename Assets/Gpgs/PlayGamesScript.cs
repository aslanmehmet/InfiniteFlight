...
public class PlayGamesScript : MonoBehaviour {
    ...
    const string SAVE_NAME = "InfiniteFlight";
    bool isSaving;
    ...
    public Sprite SignInImg;
    public Sprite SignOutImg;
    ...
    public void ChangeSing()
    {
        ...
        if (isSign)
        {
            btnSign.GetComponent<Image>().sprite = SignInImg;
            SignIn();
            Debug.Log("Çalıs lan");
            //Giris Yapıldı
        }
        ...
        {
            PlayGamesPlatform.Instance.SignOut();
            btnSign.GetComponent<Image>().sprite = SignOutImg;
            //cıkıs Yapıldı
        }
    ...
    public static void AddScoreToLeaderboard(string leaderboardId, long score)
    {
        ...
        Social.ReportScore(score, leaderboardId, success => {
            Debug.Log(score.ToString() + "eklendi");
        });
    }

    public static void SetHighScore(long value)
    {
        AddScoreToLeaderboard(GPGSIds.leaderboard_score, value);
    }
    ...
    public static void ShowLeaderboardUI()
    {
        ...
        ((PlayGamesPlatform)Social.Active).ShowLeaderboardUI("CggIpZfVjSsQAhAG");
    }
